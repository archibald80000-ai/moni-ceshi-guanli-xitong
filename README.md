...
这是《历史模拟器：崇祯》的长期档案管理仓库，用于保存季度纪要、诏书、财政、军队、人事、地方政策、密侦组织、国策和执行考成。仓库不连接游戏，也不自动替玩家执行决策。
...
- 全国军政总名册：`data/appointments/CZ11-SUMMER-NATIONAL-OFFICIAL-ROSTER-1.json`
...
- 当前人事旧详表：`data/appointments/CZ11-SUMMER-PERSONNEL-1.json`
...
- 名册原稿：`大明档案/朝臣档案/崇祯11年夏后《全国军政要员名册》原稿.md`
- 名册复核：`大明档案/朝臣档案/崇祯11年夏全国军政要员名册复核.md`
...
名册只证明“组织和责任已登记”，不自动证明任命诏、印信、到岗、兵籍、饷册和考成已经完成。
...
- 全国名册仍列毕自严在任，已作为旧值保留，不写入当前有效人事。
- 六部36名堂官称具名；季末正式实职53/54，署理维持54席运转。
- 六部侍郎职责已细分为常规执行与专项监察追责。
...
- 九级军阶实名评分赏罚无实际数。
- 九边、十三省和三支水师主官已经名册登记，但到任、印信、兵籍和兼差尚待验收。
- 锦衣卫名册编制10000、六耳军名册编制30000，均不得在未去重前计入全国军队实点。
...
- 百万亩屯田没有清册、验实和实耕实际数。
- 三级屯田军首区存在辽东13000与陕西13000冲突，不得双计。
- 鼠疫造成山西、陕西、河南死亡68000，边军辅兵减员1100。
- 四社销售25万至28万、净收益6万至7万，连续两季未达。
- 四社辖厂、市舶司已经补录；王承恩暂按监督总管处理，不直接经营。
...
5. 全国军政总名册、当前军队、地方军政水师和密侦名册
6. 当前地方政策、四社和省级面板
7. `data/current_directives.json`
8. 长期记忆、最新纪要、当前诏书和执行考成
9. 需要历史背景时再读旧固定JSON

## 强制规则

- 无实际数按未完成。
- 名册和职位登记不得冒充任命、到任、兵力和考成。
- 补入兵员不得冒充期末总实点。
- 署理不得冒充正式任命。
- 产能不得冒充产量，增长率不得冒充绝对收入。
- 股本、洋银、货值、销售、净收益和实税不得重复。
- 锦衣卫、六耳军、地方军和水师必须逐人去重。
- 密侦不掌调兵、终审和死刑执行。
- 一职一主、独立事项不超过5项继续有效。
- 四项旧自动授权176万继续冻结。
